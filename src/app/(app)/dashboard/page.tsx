...
export default function DashboardPage() {
  return (
    <div className="flex flex-1 flex-col">
      <div className="relative isolate overflow-hidden rounded-none border-b bg-card shadow-sm -m-4 sm:-mx-6 md:-m-8">
        <Image
      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4 pt-8">
